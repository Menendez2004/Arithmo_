...
export const GameScreenMedium1 = () => {
      ...
      <View style={GameStyle.container}>
        ...
        <View style={{ marginBottom: '10%' }}>
          ...
          <View style={{ alignItems: 'center' }}>
            <View style={GameStyle.container_2}>
              <Text style={{ color: 'white', textAlign: 'center', padding: 3 }}>2/11 + 5/11</Text>
            </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible2(true)}>
            <View >
              <Text style={GameStyle.answer_text}>7/11</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>7</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>7/22</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>7/12</Text>
            </View>
          </TouchableOpacity>
