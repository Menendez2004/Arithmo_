...
export const GameScreenMedium4 = () => {
      ...
      <View style={GameStyle.container}>
        ...
        <View style={{ marginBottom: '10%' }}>
          ...
          <View style={{ alignItems: 'center' }}>
            <View style={GameStyle.container_2}>
              <Text style={{ color: 'white', textAlign: 'center', padding: 3 }}>2/7 x 49/4</Text>
            </View>
        ...
        <View style={GameStyle.container_3}>
          ...
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>5</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>10/15</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>1/60</Text>
            </View>
          </TouchableOpacity>
        </View>
