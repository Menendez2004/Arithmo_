...
export const GameScreenMedium2 = () => {
      ...
      <View style={GameStyle.container}>
        ...
        <View style={{ marginBottom: '10%' }}>
          ...
          <View style={{ alignItems: 'center' }}>
            <View style={GameStyle.container_2}>
              <Text style={{ color: 'white', textAlign: 'center', padding: 3 }}>3/4 - 5/7</Text>
            </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>1/18</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>2/20</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible2(true)}>
            <View >
              <Text style={GameStyle.answer_text}>1/28</Text>
            </View>
          </TouchableOpacity>
        </View>
