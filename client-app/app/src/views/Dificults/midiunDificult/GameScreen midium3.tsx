...
export const GameScreenMedium3 = () => {
      ...
      <View style={GameStyle.container}>
        ...
        <View style={{ marginBottom: '10%' }}>
          ...
          <View style={{ alignItems: 'center' }}>
            <View style={GameStyle.container_2}>
              <Text style={{ color: 'white', textAlign: 'center', padding: 3 }}>2/5 x 3/7</Text>
            </View>
        ...
        <View style={GameStyle.container_3}>
          ...
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>6/20</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible2(true)}>
            <View >
              <Text style={GameStyle.answer_text}>6/35</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>3/14</Text>
            </View>
          </TouchableOpacity>
        </View>
        ...
        <View style={GameStyle.container_3}>
          <TouchableOpacity style={GameStyle.answer} onPress={() => setModalVisible(true)}>
            <View >
              <Text style={GameStyle.answer_text}>8/56</Text>
            </View>
          </TouchableOpacity>
        </View>
