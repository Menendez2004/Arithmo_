...
export const DificilScreen = ({ navigation }: Props) => {
            ...
            <View style={LevelStyle.container}>
                ...
                <View style={LevelStyle.container_2}>
                    ...
                    <View style={LevelStyle.container_3}>
                        ...
                        <View >
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenHard1')}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenHard3')}>
                                <View style={LevelStyle.level}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenHard5')}> 
                                <View style={LevelStyle.level}>
                        ...
                        <View>
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenHard2')}>
                                <View style={LevelStyle.level}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenHard4')}>
                                <View style={LevelStyle.level}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenHard6')}>
                                <View style={LevelStyle.level}>
