...
export const ExpertScreen = ({ navigation }: Props) => {
            ...
            <View style={LevelStyle.container}>
                ...
                <View style={LevelStyle.container_2}>
                    ...
                    <View style={LevelStyle.container_text}>
                        <Text style={LevelStyle.text}>Difucultad Experto</Text>
                    </View>
                    ...
                    <View style={LevelStyle.container_3}>
                        ...
                        <View >
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenExpert1')}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenExpert3')}>
                                <View style={LevelStyle.level}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenExpert5')}>
                                <View style={LevelStyle.level}>
                        ...
                        <View>
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenExpert2')}>
                                <View style={LevelStyle.level}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenExpert4')}>
                                <View style={LevelStyle.level}>
                            ...
                            <TouchableOpacity style={LevelStyle.container_4} onPress={() => navigation.navigate('GameScreenExpert6')}>
                                <View style={LevelStyle.level}>
